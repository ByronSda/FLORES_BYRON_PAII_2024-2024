...
public class Win_Teacher extends JFrame {
	...
	public Win_Teacher() {
		...
		JLabel lblWelcome = new JLabel("Teacher");
		...
		btnSearch.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (teacher != null) {
					...
					txtAge.setText(Integer.toString(teacher.getAge()));
				} else {
		...
		btnUpdate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Teacher teacher = new Teacher(id, name, "", 0);
